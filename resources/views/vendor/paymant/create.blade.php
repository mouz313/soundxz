          ...
          <form action="{{route('paymant.details')}}" method="post" enctype="multipart/form-data" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="email" class="form-control" name= "email" value="{{$paymant_details->email ?? ''}}"  id="email" placeholder="Please Add Email" readonly="">
                ...
                @else
                <a href="{{route('paymant.edit', ['id' => $paymant_details->autor_id])}}" id="show" class="btn btn-success" data-toggle="tooltip" title="show">
                 <i class="fa fa-pen"> </i> Change</a>
                ...
                <div class="row" >
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name= "bank_name" value="{{$paymant_details->bank_name ?? ''}}"  id="bank_name" placeholder="Please Add Bank Name" readonly="">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name= "account_no" value="{{$paymant_details->account_no ?? ''}}"  id="account_no" placeholder="Please Add Account Number/IBAN" readonly="">
                ...
                @endif
                 ...
                 <div class="row" >
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name= "national_card" value="{{$paymant_details->national_card ?? ''}}"  id="national_card" placeholder="Please Add National Card " readonly="">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name= "name" value="{{$paymant_details->name ?? ''}}"  id="name" placeholder="Please Add Name" readonly="">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <label for="email" style="margin-left: 15px; font-size: 18px;"> Paymant Detials</label>
...
@else
 <input type="radio" id="age1" style="width: 18px; height: 20px;" name="paymantstatus" value="PP"   required>
  <label for="PP" style="font-size: 18px;">PAYPAL</label>
  <input type="radio" id="age2" style="width: 18px; height: 20px;"  name="paymantstatus" value="BA"   required>
  <label for="BA" style="font-size: 18px;">BANK ACCOUNT</label>  
  <input type="radio" id="age3" style="width: 18px; height: 20px;"  name="paymantstatus" value="WU"   required>
  <label for="WU" style="font-size: 18px;">Western Union</label></div>
@endif
