        ...
        <form method="POST" action="{{ route('password.email') }}">
         ...
         <!--  <div class="m-b-md">        
            <label class="md-check">
             <input class="form-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} class="primary">
          ...
          <button type="submit" class="btn btn-lg black p-x-lg">Send link</button>
        </form>
