    ...
    <div class="row-col">
        ...
        <div class="col-sm">
          <div class="p-l-md no-padding-xs">
            ...
            @auth
            <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis">{{Auth::user()->email ?? ''}}</p>
            <div class="item-action m-b">
              
            </div>
            <div class="block clearfix m-b">
               <?php
                 $coutnory =  \App\Countory::where('id','=',Auth::user()->countory_id)->first();

                       ?>
              <i class="fa fa-map-marker" aria-hidden="true"></i>  <span class="text-muted">{{$coutnory->name}}</span>
            </div>
            @else
 <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis">''</p>
            <div class="item-action m-b">
       ...
       <!--    <div class="tab-pane active" id="track">
            <div class="row item-list item-list-by m-b">
                  <div class="col-xs-12">
                    ...
                    <div class="item-media ">
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('images/b9.jpg');"></a>
                    ...
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                        <a href="{{ route('track.details',['id' => $row->id]) }}">The Open Road</a>
                      </div>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="item-media ">
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('images/b5.jpg');"></a>
                      <div class="item-overlay center">
                        <button  class="btn-playpause">Play</button>
                      </div>
                    </div>
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                        <a href="{{ route('track.details',['id' => $row->id]) }}">Body on me</a>
                      </div>
                      <div class="item-author text-sm text-ellipsis hide">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="item-media ">
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('images/b2.jpg');"></a>
                      <div class="item-overlay center">
                        <button  class="btn-playpause">Play</button>
                      </div>
                    </div>
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                        <a href="{{ route('track.details',['id' => $row->id]) }}">I Wanna Be In the Cavalry</a>
                      </div>
                      <div class="item-author text-sm text-ellipsis hide">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="item-media ">
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('images/b4.jpg');"></a>
                      <div class="item-overlay center">
                        <button  class="btn-playpause">Play</button>
                      </div>
                    </div>
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                        <a href="{{ route('track.details',['id' => $row->id]) }}">Live Radio</a>
                      </div>
                      <div class="item-author text-sm text-ellipsis hide">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="item-media ">
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('images/b6.jpg');"></a>
                      <div class="item-overlay center">
                        <button  class="btn-playpause">Play</button>
                      </div>
                    </div>
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                        <a href="{{ route('track.details',['id' => $row->id]) }}">Reflection (Deluxe)</a>
                      </div>
                      <div class="item-author text-sm text-ellipsis hide">
          ...
          @foreach($song_id as $row1)
                  
                      <?php
                 $song[] =  \App\AutorSong::where('id','=',$row1)->where('status','=',1)->get();
...
<div class="item-media ">
                     ...
                     <!--  <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image:url('images/b11.jpg');"></a> -->
                      <div class="item-overlay center">
                      <!-- <button  class="btn-playpause  playsong" id="playsong"  onclick="myFunction()"     value="">Play</button> -->
                      </div>
                    </div>
                    ...
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                       <!--  <a href="{{ route('track.details',['id' => $row->id]) }}">Title</a> -->
                      </div>
                      <div class="item-author text-sm text-ellipsis hide">
                        <a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="text-muted">Pablo Nouvelle</a>
                      </div>
             ...
             @else
                    <div class="item-media ">
                      ...
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('{{ asset($value->img)  }}');"></a>
                      <div class="item-overlay center">
                      <button  class="btn-playpause  playsong" id="playsong"  onclick="myFunction()"     value="{{url($value->song)}}">Play</button>
                      </div>
                    </div>
                    ...
                    <div class="item-info">
                      ...
                      <div class="item-title text-ellipsis">
                        <a href="{{ route('track.details',['id' => $row->id]) }}">{{$value->title}}</a>
                      </div>
                      <div class="item-author text-sm text-ellipsis hide">
                        <a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="text-muted">Pablo Nouvelle</a>
                      </div>
                      <div class="item-meta text-sm text-muted">
                            <span class="item-meta-stats text-xs ">
                              <!-- <i class="fa fa-play text-muted" style="color: blue;"></i>  
                              <i class="fa fa-heart m-l-sm text-muted" style="color: red;"></i>  -->
                            </span>
                          </div>
            ...
            <div class="row m-b">
                ...
                @if(count($songs)==0)
                    ...
                    <div class="item-media ">
                      ...
                      <!-- <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('');"></a> -->
                      <div class="item-overlay center">
                        <!--  <button  class="btn-playpause  playsong" id="playsong"  onclick="myFunction()"     value="">Play</button> -->
                      </div>
                    </div>
                ...
                @foreach($songs as $value)
                    ...
                    <div class="item-media ">
                      ...
                      <a href="{{ route('track.details',['id' => $row->id]) }}" class="item-media-content" style="background-image: url('{{ asset($value->img)  }}');"></a>
                      <div class="item-overlay center">
                         <button  class="btn-playpause  playsong" id="playsong"  onclick="myFunction()"     value="{{url($value->song_pre)}}">Play</button>
                      </div>
                    </div>
                    <div class="item-info">
                      <div class="item-overlay bottom text-right">
          ...
          <div class="tab-pane active " id="profile" style="margin-bottom: 280px;">
            <form action="{{route('user.profile.update')}}" method="post" enctype="multipart/form-data" >
                     @csrf
              <div class="form-group row">
                <div class="col-sm-3 form-control-label text-muted">Name</div>
                <div class="col-sm-9"><input type="text" name="name" placeholder="Name" value="{{Auth::user()->name  }}" class="form-control"></div>
              </div>
              <div class="form-group row">
                <div class="col-sm-3 form-control-label text-muted">Email</div>
                <div class="col-sm-9"><input type="text" name="email" value="{{Auth::user()->email  }}" placeholder="Email" class="form-control"></div>
              </div>
               <div class="form-group row">
                <div class="col-sm-3 form-control-label text-muted">Phone Number</div>
                <div class="col-sm-9"><input type="number" name="number" placeholder="Phone Number" value="{{Auth::user()->number  }}" class="form-control"></div>
              </div>
              <div class="form-group row">
                <?php
                 $countory =  \App\Countory::all();
                  ...
                  ?>
                <div class="col-sm-3 form-control-label text-muted">Countory</div>
                <div class="col-sm-9">
                  <select class="form-control c-select">
                     <option value="">Select Countory</option>
                            @foreach($countory as $row)
                            <option value="{{$row->id}}" {{ Auth::user()->countory_id == $row->id ? 'selected' : '' }} {{old('countory_id') == $row->id ? 'selected' : ''}}>{{$row->name}}</option>
                            @endforeach
                  </select>
                </div><br><br><br>
               <div class="offset-sm-2 col-sm-10">
                          <button type="submit" style="width: 50%;" class="btn btn-danger">Submit</button>
                        </div>
              </div>
            </form>
            ...
            <form action="{{route('user.password.update')}}" method="post" enctype="multipart/form-data" >
                     @csrf
              <div class="form-group row">
                <div class="col-sm-3 form-control-label text-muted">Old Password</div>
                <div class="col-sm-9"><input type="password" name="old_password" placeholder="Old Password"  class="form-control"></div>
              </div>

       

              <div class="form-group row">
                <div class="col-sm-3 form-control-label text-muted">New Password</div>
                <div class="col-sm-9"><input type="password" type="password" name="password"  placeholder="New Password" class="form-control @error('password') is-invalid @enderror" required autocomplete="new-password">
                   @error('password')
               ...
               <div class="form-group row">
                <div class="col-sm-3 form-control-label text-muted">Confirm Password </div>
                <div class="col-sm-9"><input  type="password" placeholder="Re-enter Password" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" ></div>
              </div>
              <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <div class="row item-list item-list-sm item-list-by m-b">
                          ...
                          <div class="col-xs-12">
                            <div class="item">
                            <div class="item-media rounded ">
                              <a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="item-media-content" style="background-image: url('images/b1.jpg');"></a>
                            </div>
                            <div class="item-info ">
                              <div class="item-title text-ellipsis">
                                <a href="{{ route('artist.details', ['id' => $row->id] ) }}">Melissa Garza</a>
                                <div class="text-sm text-muted">20 songs</div>
                              </div>
                            </div>
                          </div>
