      			    ...
      			    <div class="col-xs-4 col-sm-4 col-md-3">
      			    	<div class="item r" data-id="item-3" data-src="http://api.soundcloud.com/tracks/79031167/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
      						<div class="item-media ">
      							<a href="{{ route('track.details') }}" class="item-media-content" style="background-image: url('{{ asset($row1->img) }}');"></a>
      						...
      						<div class="item-info">
      							...
      							<div class="item-title text-ellipsis">
      								<a href="{{ route('track.details') }}">{{$row1->title}}</a>
      							</div>
                    <?php
                             $artist =  \App\Vendor::where('status','=',0)->where('id','=',$row1->autor_id)->first();
  
                     ?>
      							<div class="item-author text-sm text-ellipsis ">
      								<a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="text-muted">{{$artist->name}}</a>
      							</div>
                  ...
                  <div class="col-sm-6">
                    <div class="row item-list item-list-sm item-list-by m-b">
                          ...
                          <div class="col-xs-12">
                          	<div class="item">
                      			<div class="item-media rounded ">
                      				<a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="item-media-content" style="background-image: url('images/a8.jpg');"></a>
                      			</div>
                      			<div class="item-info ">
                      				<div class="item-title text-ellipsis">
                      					<a href="{{ route('artist.details', ['id' => $row->id] ) }}">Sara King</a>
