...
?>
  ...
  <p class="m-b-md"><strong>0</strong> Results found for: <strong>Keyword</strong></p>
  <div class="m-y">
    <div class="row item-list item-list-lg item-list-by m-b">
        <h1 style="margin-top: 280px; margin-bottom: 280px; text-align: center;">Data Not Found</h1>
    </div>
    <div>
                    ...
                    <div class="row item-list item-list-sm item-list-by m-b">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="item-info">
                              ...
                              <div class="item-author text-sm text-ellipsis ">
                                <a href="#" class="text-muted">Kygo</a>
                              </div>
                              <div class="item-meta text-sm text-muted">
                                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="row item-list item-list-sm item-list-by m-b">
                          ...
                          <div class="col-xs-12">
                            <div class="item">
                            <div class="item-media rounded ">
                              <a href="#" class="item-media-content" style="background-image: url('images/a7.jpg');"></a>
                            </div>
                            <div class="item-info ">
                              <div class="item-title text-ellipsis">
                                <a href="#">Richard Carr</a>
                          ...
                          <div class="col-xs-12">
                            <div class="item">
                            <div class="item-media rounded ">
                              <a href="#" class="item-media-content" style="background-image: url('images/a1.jpg');"></a>
                            </div>
                            <div class="item-info ">
                              <div class="item-title text-ellipsis">
                                <a href="#">James Garcia</a>
                          ...
                          <div class="col-xs-12">
                            <div class="item">
                            <div class="item-media rounded ">
                              <a href="#" class="item-media-content" style="background-image: url('images/a9.jpg');"></a>
                            </div>
                            <div class="item-info ">
                              <div class="item-title text-ellipsis">
                                <a href="#">Douglas Torres</a>
