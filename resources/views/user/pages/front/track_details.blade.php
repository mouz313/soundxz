...
?>
 @foreach($artist as $row)
  ...
  @foreach($songs as $row1)
    
<div class="pos-rlt" style="">
...
<div class="page-content">
        ...
        <div class="col-sm w w-auto-xs m-b">
          <div class="item w r">
            <div class="item-media">
              <div class="item-media-content" style="background-image: url('{{ asset($song->img) }}');"></div>
            </div>
          </div>
        </div>
        <div class="col-sm">
          <div class="p-l-md no-padding-xs">
            ...
            <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis" style="font-size: 15px;">{{$song->description}}</p>
            <div class="item-action m-b">
              ...
              <button class="btn-playpause text-primary m-r-sm playsong" id="playsong"  onclick="myFunction()"     value="{{url($row1->song)}}"></button> 

              @auth
               <?php
                              
                             $likes =  \App\Like::where('user_id','=',Auth::user()->id)->where('song_id','=',$row->id)->first();
                                  $likess =  \App\Like::where('like','=',1)->where('song_id','=',$row->id)->get();

                                  //Playsong
                                $playSong =  \App\Playsong::where('user_id','=',Auth::user()->id)->where('song_id','=',$row->id)->first();
                                  $playSongs = \App\Playsong::where('like','=',1)->where('song_id','=',$row->id)->get();

                                  ?>
              <span class="text-muted">{{$playSongs->count()}}</span>
            ...
            $category =  \App\Song::where('id','=',$song->category_id)->first();
             ...
             ?>
            <div class="item-meta">
              <a class="btn btn-xs rounded white" style="font-size: 15px;">{{$category->title}}</a> 
            </div>
          </div>
        </div>
    </div>
  ...
  <div class="row-col" style="margin-bottom: 350px;">
    <div class="col-lg-9 b-r no-border-md">
      <div class="padding">
             <?php

            $autor =  \App\Vendor::where('id','=',$song->autor_id)->first();
            $autor_songs =  \App\AutorSong::where('autor_id','=',$song->autor_id)->where('status','=',1)->get();
          ...
          <h6 class="m-b">
            ...
            <a href="{{ route('artist.details', ['id' => $row->id] ) }}" data-pjax class="item-author _600" style="font-size: 20px;">{{$autor->name}}</a> 
            <span class="text-muted text-sm" style="font-size: 20px;">- {{$autor_songs->count()}} song,</span>
          </h6>
          <div id="tracks" class="row item-list item-list-xs item-list-li m-b">
               
                @foreach($autor_songs as $value)
                <div class="col-xs-12">
                	<div class="item r" data-id="item-12" data-src="http://api.soundcloud.com/tracks/174495152/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
            			<div class="item-media ">
            				<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b11.jpg');"></a>
            			...
            			<div class="item-info">
            				...
            				<div class="item-title text-ellipsis">
            					<a href="{{ route('track.details',['id' => $row1->id]) }}">{{$value->title}}</a>
            				</div>
          ...
          <div class="row m-b">
                <div class="col-xs-6 col-sm-6 col-md-3">
                	<div class="item r" data-id="item-12" data-src="http://api.soundcloud.com/tracks/174495152/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
            			...
            			<div class="item-info">
            				...
            				<div class="item-title text-ellipsis">
            					<a href="{{ route('track.details',['id' => $row1->id]) }}">Happy ending</a>
            				</div>
            				<div class="item-author text-sm text-ellipsis hide">
            					<a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="text-muted">Postiljonen</a>
            				</div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-3">
                	<div class="item r" data-id="item-5" data-src="http://streaming.radionomy.com/JamendoLounge">
            			<div class="item-media ">
            				<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b4.jpg');"></a>
            				<div class="item-overlay center">
            					<button  class="btn-playpause">Play</button>
            				</div>
            			</div>
            			<div class="item-info">
            				...
            				<div class="item-title text-ellipsis">
            					<a href="{{ route('track.details',['id' => $row1->id]) }}">Live Radio</a>
            				</div>
            				<div class="item-author text-sm text-ellipsis hide">
                ...
                <div class="col-xs-6 col-sm-6 col-md-3">
                	<div class="item r" data-id="item-1" data-src="http://api.soundcloud.com/tracks/269944843/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
            			<div class="item-media ">
            				<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b0.jpg');"></a>
            				<div class="item-overlay center">
            					<button  class="btn-playpause">Play</button>
            				</div>
            			</div>
            			<div class="item-info">
            				...
            				<div class="item-title text-ellipsis">
            					<a href="{{ route('track.details',['id' => $row1->id]) }}">Pull Up</a>
            				</div>
            				<div class="item-author text-sm text-ellipsis hide">
                ...
                <div class="col-xs-6 col-sm-6 col-md-3">
                	<div class="item r" data-id="item-8" data-src="http://api.soundcloud.com/tracks/236288744/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
            			<div class="item-media ">
            				<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b7.jpg');"></a>
            				<div class="item-overlay center">
            					<button  class="btn-playpause">Play</button>
            				</div>
            			</div>
            			<div class="item-info">
            				...
            				<div class="item-title text-ellipsis">
            					<a href="{{ route('track.details',['id' => $row1->id]) }}">Simple Place To Be</a>
            				</div>
            				<div class="item-author text-sm text-ellipsis hide">
      	...
      	<div class="row item-list item-list-sm m-b">
      		    ...
      		    <div class="col-xs-12">
      		    	<div class="item r" data-id="item-11" data-src="http://api.soundcloud.com/tracks/218060449/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
      					<div class="item-media ">
      						<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b10.jpg');"></a>
      					</div>
      					<div class="item-info">
      						<div class="item-title text-ellipsis">
      							<a href="{{ route('track.details',['id' => $row1->id]) }}">Spring</a>
      						</div>
      						<div class="item-author text-sm text-ellipsis ">
      		    ...
      		    <div class="col-xs-12">
      		    	<div class="item r" data-id="item-10" data-src="http://api.soundcloud.com/tracks/237514750/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
      					<div class="item-media ">
      						<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b9.jpg');"></a>
      					</div>
      					<div class="item-info">
      						<div class="item-title text-ellipsis">
      							<a href="{{ route('track.details',['id' => $row1->id]) }}">The Open Road</a>
      						</div>
      						<div class="item-author text-sm text-ellipsis ">
      							<a href="{{ route('artist.details', ['id' => $row->id] ) }}" class="text-muted">Postiljonen</a>
      						</div>
                    ...
                    <div class="row item-list item-list-sm item-list-by m-b">
                          ...
                          <div class="col-xs-12">
                          	<div class="item r" data-id="item-6" data-src="http://api.soundcloud.com/tracks/236107824/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
                      			<div class="item-media ">
                      				<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b5.jpg');"></a>
                      			</div>
                      			<div class="item-info">
                      				<div class="item-title text-ellipsis">
                      					<a href="{{ route('track.details',['id' => $row1->id]) }}">Body on me</a>
                      				</div>
                      				<div class="item-author text-sm text-ellipsis ">
                          ...
                          <div class="col-xs-12">
                          	<div class="item r" data-id="item-2" data-src="http://api.soundcloud.com/tracks/259445397/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
                      			<div class="item-media ">
                      				<a href="{{ route('track.details',['id' => $row1->id]) }}" class="item-media-content" style="background-image: url('images/b1.jpg');"></a>
                      			</div>
                      			<div class="item-info">
                      				<div class="item-title text-ellipsis">
                      					<a href="{{ route('track.details',['id' => $row1->id]) }}">Fireworks</a>
                      				</div>
                      				<div class="item-author text-sm text-ellipsis ">
